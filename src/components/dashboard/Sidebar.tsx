...
debugger;
  ...
  const navItems = [
    ...
    { name: 'Patients', href: '/patients', icon: 'fas fa-user-injured', roles: ['admin', 'doctor'] },
    { name: 'Appointments', href: '/appointments', icon: 'fas fa-calendar-alt', roles: ['admin', 'doctor', 'patient'] },
